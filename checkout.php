						...
						<div class="col-md-6">
							<div class="cart-detail bg-light p-3 p-md-4">
								...
								<div class="form-group">
									<div class="col-md-12">
										<div class="radio">
											<label><input type="radio" name="optradio" class="mr-2"> Bonifico</label>
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-12">
										<div class="radio">
											<label><input type="radio" name="optradio" class="mr-2"> Carta</label>
										</div>
									</div>
								</div>
								<div class="form-group">
								...
								<p><a href="#" class="btn btn-primary py-3 px-4">Paga e ordina</a></p>
							</div>
						</div>
					</div>
				</div> <!-- .col-md-8 -->
