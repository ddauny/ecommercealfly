...
if ($result->num_rows > 0) {
	...
	$_SESSION["quantita"] = $row["quantita"];
...
<head>
	<title>DaShop - <?php echo $_SESSION["nome"] ?></title>
	<meta charset="utf-8">
				...
				<div class="col-lg-12 d-block">
					<div class="row d-flex">
						...
						<div class="col-md pr-4 d-flex topper align-items-center">
							...
							<span class="text">iania_daniele@ismmonnet.onmicrosoft.com</span>
						</div>
	...
	<section class="ftco-section">
		<div class="container">
			<div class="row">
				...
				<?php echo "<a href='$_SESSION[img]' class='image-popup prod-img-bg'><img src='$_SESSION[img]' class='img-fluid' alt='Colorlib Template'></a>" ?>			
				</div>
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p class="price"><span>€<?php echo $_SESSION["prezzo"];?></span></p>
					<p><?php echo $_SESSION["descrizione"]; ?></p>
					<div class="row mt-4">
						<div class="w-100"></div>
						...
						<div class="w-100"></div>
						<div class="col-md-12">
							<p style="color: #000;"><?php echo $_SESSION["quantita"]; ?> pezzi disponibili</p>
						</div>
					</div>
					<?php echo "<input class='btn btn-black py-3 px-5 mr-2' type='button' onclick='add($_GET[id])' style='display:' value='Aggiungi al carrello'/>" ?>
					
					<script>
						function add(id){
							let q = document.getElementById("quantity").value;
							window.location.replace("addCart.php?id=" + id + "&q=" + q);
						}
			...
			<div class="row mt-5">
				<div class="col-md-12 nav-link-wrap">
					<div class="nav nav-pills d-flex text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						<a class="nav-link ftco-animate active mr-lg-1" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">Descrizione</a>


						<a class="nav-link ftco-animate" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-3" aria-selected="false">Recensioni</a>
						...
						<div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
							<div class="p-4">
								<h3 class="mb-4"><?php
													...
													?></h3>
													<?php echo "<p> $_SESSION[descrizione] </p>" ?>
								</div>
						</div>
